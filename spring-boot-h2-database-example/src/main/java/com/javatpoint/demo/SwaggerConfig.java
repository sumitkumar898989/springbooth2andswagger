...
private Predicate<String> postPaths() {
	return or(regex("/student/posts.*"), regex("/student.*"));
}
...
private ApiInfo apiInfo() {
	return new ApiInfoBuilder().title("Student API")
			...
			.contact("sumitkumar8989@gmail.com").license("Student License")
			.licenseUrl("sumitkumar8989@gmail.com").version("1.0").build();
}
}
